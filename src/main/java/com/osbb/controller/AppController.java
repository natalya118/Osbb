...
public class AppController {
	...
	@RequestMapping(value = { "/viewStudentDetails-{ssoId}" }, method = RequestMethod.GET)
	public String viewStudent(@PathVariable String ssoId, ModelMap model) {
		User user = userService.findBySSO(ssoId);
		model.addAttribute("user", user);
		model.addAttribute("edit", true);
		model.addAttribute("loggedinuser", getPrincipal());
    ...
    public ResponseEntity<?> login(@RequestBody User user) {
        ...
        return new ResponseEntity<>(userService.findBySSO(user.getSsoId()), HttpStatus.OK);
    }
	/**
