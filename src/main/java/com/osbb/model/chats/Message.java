...
public class Message {
	...
	private boolean ÒurUserMessage;


	public boolean is—urUserMessage() {
		return ÒurUserMessage;
	}
	public void set—urUserMessage(boolean ÒurUserMessage) {
		this.ÒurUserMessage = ÒurUserMessage;
	}
